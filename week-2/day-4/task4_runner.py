...
--------------------------------------------------
Same task as Task 3, but with Process.hierarchical.
Manager agent oversees the work, reviews output, can request revisions.
"""
...
# LLM CONFIG
# =============================================================================
# Manager: temp=0.3 (needs to make good decisions)
# Workers: same as Task 3
...
# =============================================================================
# ASSEMBLE CREW — Process.hierarchical + manager_llm
# =============================================================================
crew = Crew(
...
print("=" * 60)
print("RUNNING CREWAI CREW (HIERARCHICAL)")
print("=" * 60)
result = crew.kickoff()
